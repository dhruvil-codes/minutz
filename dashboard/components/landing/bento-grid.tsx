...
function CustomizableMark() {
  return (
    <div className="relative flex h-24 w-56 items-center">
      ...
      <span className="mx-auto block w-fit text-5xl font-semibold">60s</span>
    </div>
  );
}
...
function SpeedChart() {
  return (
    <svg
      ...
      xmlns="http://www.w3.org/2000/svg"
    >
      <rect width="386" height="123" rx="10" fill="currentColor" opacity="0.04" />
      <circle className="text-muted-foreground dark:text-muted" cx="29" cy="29" r="15" fill="currentColor" />
      <path d="M29 23V35" stroke="white" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" />
      <path d="M35 29L29 35L23 29" stroke="white" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" />
      <path
        fillRule="evenodd"
        clipRule="evenodd"
      ...
      />
      <defs>
        <linearGradient id="speed-fill" x1="3" x2="3" y1="60" y2="123" gradientUnits="userSpaceOnUse">
...
function SignalChart() {
  return (
    <svg className="w-full sm:w-[150%]" viewBox="0 0 366 231" fill="none" xmlns="http://www.w3.org/2000/svg">
      ...
      />
      <defs>
        <linearGradient id="signal-fill" x1="0.85108" x2="0.85108" y1="0.947876" y2="230.114" gradientUnits="userSpaceOnUse">
          <stop className="text-primary/15 dark:text-primary/35" stopColor="currentColor" />
      ...
      <div className="mx-auto max-w-3xl px-6 lg:max-w-5xl">
        <div className="relative">
          <div className="relative z-10 grid grid-cols-6 gap-3">
            <AnimatedCard index={0} className="col-span-full lg:col-span-2">
            ...
            <AnimatedCard index={1} className="col-span-full sm:col-span-3 lg:col-span-2">
            ...
            <AnimatedCard index={2} className="col-span-full sm:col-span-3 lg:col-span-2">
              <Card className="relative h-full overflow-hidden">
                <CardContent className="pt-6">
            ...
            <AnimatedCard index={3} className="col-span-full lg:col-span-3">
              <Card className="relative h-full overflow-hidden">
            ...
            <AnimatedCard index={4} className="col-span-full lg:col-span-3">
              <Card className="relative h-full overflow-hidden">
                  ...
                  <div className="before:bg-border relative mt-6 before:absolute before:inset-0 before:mx-auto before:w-px sm:-my-6 sm:-mr-6">
                    <div className="relative flex h-full flex-col justify-center space-y-6 py-6">
                      <div className="relative flex w-[calc(50%+0.875rem)] items-center justify-end gap-2">
                        <span className="block h-fit rounded border px-2 py-1 text-xs shadow-sm">Sales AE</span>
                      ...
                      <div className="relative ml-[calc(50%-1rem)] flex items-center gap-2">
                        ...
                        <span className="block h-fit rounded border px-2 py-1 text-xs shadow-sm">Product Manager</span>
                      </div>
                      <div className="relative flex w-[calc(50%+0.875rem)] items-center justify-end gap-2">
                        <span className="block h-fit rounded border px-2 py-1 text-xs shadow-sm">Financial Advisor</span>
                        <div className="ring-background size-7 ring-4">
                          <img
                            className="size-full rounded-full"
