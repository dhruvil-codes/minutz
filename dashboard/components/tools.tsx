...
type Tool = { name: string; lightImage: string };
...
export default function ToolFeature() {
    const tools: Tool[] = [
        ...
        { name: "Mailchip", lightImage: "/logo/templates/axis/mailchip.svg" },
        ...
        >
            <div className="mb-12 flex flex-col items-center gap-3 px-4 text-center">
                ...
                <p className="max-w-md text-sm text-muted-foreground sm:text-base">
                    Minutz pushes results to Slack, Notion, HubSpot, Linear, and more — automatically.
                </p>
            </div>
            ...
            <div className="flex items-center justify-center -space-x-3">
                {tools.map((tool, index) => (
                    ...
                    >
                        <Image src={tool.lightImage} alt={tool.name} width={56} height={56} className="h-full w-full object-contain" />
                    </motion.div>
                ))}
            </div>
        </motion.div>
