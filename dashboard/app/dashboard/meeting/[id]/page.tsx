  ...
  return (
    <Card className={`${SOFT_SURFACE} overflow-hidden`}>
      <CardContent className="flex min-h-[220px] flex-col items-center justify-center p-10 text-center">
        ...
        <CardDescription className="mt-2 max-w-md text-[#E5E5E5]">
          {description}
        </CardDescription>
      </CardContent>
    </Card>
    ...
    <Card className={`${SURFACE} overflow-hidden`}>
      <CardContent className="flex flex-col items-center justify-center gap-7 p-14 text-center">
        ...
        <CardHeader className="p-0">
          ...
          <CardDescription className="mx-auto mt-2 max-w-xl text-[#E5E5E5]">
  ...
  return (
    <Card className={`${SURFACE} lg:col-span-2`}>
      <CardHeader>
        ...
        <CardTitle className="text-[20px] font-bold text-white">Mode-specific signals</CardTitle>
        <CardDescription className="text-[13px] text-[#6B6B6B]">
...
export default function MeetingDetailPage() {
  ...
  if (loading) {
    return (
      <Card className={`${SURFACE} mx-auto max-w-6xl`}>
      ...
      {isProcessing ? (
        ...
        <Tabs defaultValue="summary" className="flex w-full flex-col gap-5">
          <TabsList className="grid h-auto w-full grid-cols-2 gap-2 rounded-2xl border border-[#2A2A2A] bg-[#1A1A1A] p-2 md:grid-cols-4">
            <TabsTrigger
              value="summary"
              className="!h-auto rounded-xl !px-6 !py-3 !text-[14px] !font-medium !text-[#6B6B6B] transition-colors hover:!text-[#A3A3A3] data-active:!border-b-2 data-active:!border-b-[#FF6A00] data-active:!bg-transparent data-active:!text-white"
            >
          ...
          <TabsContent value="summary" className="w-full grid gap-6 lg:grid-cols-3">
            <Card className={`rounded-[12px] border border-[#2A2A2A] bg-transparent text-white shadow-none lg:col-span-2`}>
              <CardHeader className="px-8 pt-8">
                <Badge className="mb-3 w-fit border-[#FF6A00]/30 bg-[#FF6A00]/10 text-[#FF6A00]">
                  Executive Summary
                </Badge>
                <CardTitle className="mb-4 text-[22px] font-bold text-white">What happened</CardTitle>
              </CardHeader>
              <CardContent className="px-8 pb-8">
                <div className="rounded-[12px] border border-[#2A2A2A] bg-transparent p-8">
                  <p className="text-[16px] leading-[1.8] text-[#E5E5E5]">
            ...
            <Card className={SURFACE}>
              <CardHeader>
                ...
                <CardTitle className="text-[16px] font-bold text-white">Meeting pulse</CardTitle>
                <CardDescription className="mb-4 text-[14px] text-[#6B6B6B]">
                  Sentiment and urgency distilled from the transcript.
                </CardDescription>
              </CardHeader>
              <CardContent className="divide-y divide-[#2A2A2A]">
                <div className="flex items-center justify-between py-4">
                  <CardDescription className="text-[14px] text-[#A3A3A3]">Sentiment</CardDescription>
                  <Badge className={`${sentimentColor(summary.sentiment)} rounded-full border px-3 py-1 text-[12px] font-semibold`}>
                    {summary.sentiment || "neutral"}
                  </Badge>
                </div>
                <div className="flex items-center justify-between py-4">
                  <CardDescription className="text-[14px] text-[#A3A3A3]">Urgency</CardDescription>
                  <Badge className={`${urgencyColor(summary.urgency)} rounded-full border px-3 py-1 text-[12px] font-semibold`}>
                    {summary.urgency || "low"}
                  </Badge>
                </div>
                <div className="flex items-center justify-between py-4 last:pb-0">
                  <CardDescription className="text-[14px] text-[#A3A3A3]">Next step load</CardDescription>
                  <Badge className="rounded-full border border-[#FF6A00]/30 bg-[#FF6A00]/15 px-3 py-1 text-[12px] font-semibold text-[#FF6A00]">
